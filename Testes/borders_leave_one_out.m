function borders_leave_one_out(original_dataset_path, marc, marc_label)
...
% marc = [ 4 5 11 14 16 ];
%% Tube 1 + Tube 2
% marc = [1 4 5 6 8 11 13 14 16 18];
%% Tube 1 + Tube 3
%marc = [3 4 5 10 11 14 16 19 23 24];
%% Tube 1 + Tube 2 + Tube 3
% marc = [1 3 4 5 6 8 10 11 13 14 16 18 19 23 24];
train_set = extract_features(marc, train_set);

patient_set = 1:size(train_set,2);
